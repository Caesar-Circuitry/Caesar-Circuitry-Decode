...
public class RedFarAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        paths = new RedStartFromFar(robot.getHardware().getFollower());
        robot.getHardware().getFollower().setStartingPose(RedStartFromFar.START_POSE);
        schedule(
...
//                        robot.getHardware().getTurret().TargetRedGoal(),
                        ...
                        // ==================== LAUNCH 1 ====================
                        new InstantCommand(()->robot.getHardware().getLauncher().LaunchPose(paths.launch1().endPose(), Constants.Robot.RedGoal)),
                        ...
                        // ==================== LAUNCH 2 ====================
                        new InstantCommand(()->robot.getHardware().getLauncher().LaunchPose(paths.launch2().endPose(), Constants.Robot.RedGoal)),
                        ...
                        // ==================== LAUNCH 3 ====================
                        new InstantCommand(()->robot.getHardware().getLauncher().LaunchPose(paths.launch3().endPose(), Constants.Robot.RedGoal)),
                        ...
                        // ==================== LAUNCH 4 ====================
                        new InstantCommand(()->robot.getHardware().getLauncher().LaunchPose(paths.launch4().endPose(), Constants.Robot.RedGoal)),
                        ...
                        // ==================== LAUNCH 5 (Final) ====================
                        new InstantCommand(()->robot.getHardware().getLauncher().LaunchPose(paths.launch5().endPose(), Constants.Robot.RedGoal)),
